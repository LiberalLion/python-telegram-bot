...
class Location(TelegramObject):
    ...
    def __init__(
        ...
        **_kwargs: Any,
        ...
        # Optionals
        self.horizontal_accuracy = horizontal_accuracy if horizontal_accuracy else None
        self.live_period = live_period if live_period else None
        self.heading = heading if heading else None
        self.proximity_alert_radius = (
            proximity_alert_radius if proximity_alert_radius else None
        )
